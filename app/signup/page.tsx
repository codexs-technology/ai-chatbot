  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#07090b] px-4 py-12 text-white">
      <div className="w-full max-w-md rounded-[28px] border border-white/10 bg-[#111214] p-6 shadow-2xl shadow-black/25">
        ...
        <div className="mt-8">
          <p className="text-sm uppercase tracking-[0.2em] text-zinc-400">Get started</p>
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div>
            <label htmlFor="signup-email" className="mb-2 block text-sm text-zinc-300">Email</label>
            <input
              id="signup-email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="signup-password" className="mb-2 block text-sm text-zinc-300">Password</label>
        ...
        <p className="mt-5 text-center text-sm text-zinc-400">
          Already have an account? <Link href="/login" className="font-medium text-white">Sign in</Link>
        </p>
      </div>
    </div>
  );
